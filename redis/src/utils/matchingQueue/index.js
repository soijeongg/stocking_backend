import { matching } from '../redisMatching/index.js';
class Queue {
  constructor() {
    this.items = [];
...
const matchingQueue = new Queue();

async function insertMatchingMessageQueue(messageString) {
  matchingQueue.enqueue(messageString);
}

export { insertMatchingMessageQueue };
