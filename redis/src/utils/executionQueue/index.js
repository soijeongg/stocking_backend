import { execution } from '../MySQLExecution/index.js'
class Queue {
  constructor() {
    this.items = [];
...
async function insertExecutionMessageQueue(messageString) {
  executionQueue.enqueue(messageString);
}

export { insertExecutionMessageQueue };
